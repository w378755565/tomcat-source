...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try{
            Context context = new Context("/javaweb", "D:/idea_project/javaweb/web", null, true);
            File file = new File("D:/idea_project/javaweb/web/index.jsp");
    ...
    public static void compileJsp(Context context, File file)throws JasperException {
        ...
        subFolder = "/".equals(path) ? "_" : StrUtil.subAfter(path, '/', false);
    ...
    public static final boolean isJavaKeyword(String key){
        int i = 0;
